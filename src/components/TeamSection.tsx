          ...
          {members.map((m, i) => (
            ...
            >
              <motion.div
                ...
                className="bg-card rounded-3xl p-7 border border-border hover:shadow-xl hover:shadow-campaign-green/5 hover:border-campaign-green/20 transition-all duration-500 cursor-default h-full"
              >
                <div className="w-14 h-14 rounded-2xl gradient-green flex items-center justify-center mb-5 shadow-lg shadow-campaign-green/20 group-hover:scale-110 group-hover:shadow-xl group-hover:shadow-campaign-green/25 transition-all duration-300">
