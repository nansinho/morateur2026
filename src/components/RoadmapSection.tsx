              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    {m.done && (
                      <div className="w-5 h-5 rounded-full bg-campaign-green flex items-center justify-center">
                        <Check className="w-3 h-3 text-primary-foreground" />
                      </div>
                    )}
                  </div>

                  <h3 className={`font-heading font-extrabold text-xl mb-2 ${m.done ? "text-foreground" : "text-foreground/50"}`}>
                    {m.title}
                  </h3>
