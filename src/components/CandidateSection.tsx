        ...
        <div className="absolute bottom-20 left-0 right-0 z-10">
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <h2 className="font-heading text-5xl md:text-8xl font-extrabold text-foreground leading-[0.9] mt-2">
                Mathieu<br />
        ...
        <div className="container mx-auto px-6 py-28 relative z-10">
          ...
          >
            ...
            <blockquote className="relative pl-8 border-l-[3px] border-campaign-green/30">
              <p className="text-foreground/70 italic text-2xl md:text-4xl leading-snug font-heading font-light">
          ...
          <div className="max-w-3xl mx-auto mb-24 space-y-6">
            <motion.p className="text-muted-foreground leading-relaxed text-lg" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
            ...
            <motion.p className="text-muted-foreground leading-relaxed text-lg" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7, delay: 0.15 }}>
