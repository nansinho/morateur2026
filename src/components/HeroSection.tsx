...
const HeroSection = () => {
  ...
  return (
    <section ref={ref} id="hero" className="relative h-screen flex items-center overflow-hidden">
      ...
      {/* Decorative blobs */}
      <div className="absolute top-20 left-10 w-64 h-64 rounded-full bg-campaign-green/10 blur-3xl" />
      <div className="absolute bottom-40 left-[30%] w-48 h-48 rounded-full bg-campaign-gold/10 blur-3xl" />
      ...
      <motion.div className="relative container mx-auto px-6" style={{ y: textY, opacity }}>
        <div className="max-w-2xl">
          <motion.div
            className="inline-flex items-center gap-2 bg-campaign-green/20 text-campaign-green font-bold text-xs uppercase tracking-[0.2em] mb-8 px-4 py-2 rounded-full"
          ...
          <div className="overflow-hidden mb-6">
            ...
            >
              ...
              <span className="text-campaign-coral"> !</span>
            </motion.h1>
          </div>
          ...
          >
            Avec <span className="text-campaign-green font-bold">Mathieu Morateur</span>, construisons ensemble une commune où il fait bon vivre 🌿
          </motion.p>
          ...
          >
            <motion.button
              ...
              className="gradient-green text-primary-foreground px-8 py-4 rounded-full font-extrabold text-base flex items-center gap-2 shadow-xl shadow-campaign-green/25"
            ...
            <motion.button
              ...
              className="bg-campaign-gold text-primary px-8 py-4 rounded-full font-extrabold text-base shadow-xl shadow-campaign-gold/25"
              whileHover={{ scale: 1.08, y: -4, rotate: -1 }}
              whileTap={{ scale: 0.95 }}
            >
              Rejoignez-nous 🤝
      ...
      {/* Info badges — fun, colorful, tilted */}
      <motion.div
      ...
      >
        <motion.div
          className="bg-campaign-green rounded-2xl px-7 py-5 shadow-xl"
        ...
        <motion.div
          className="bg-campaign-gold rounded-2xl px-7 py-5 shadow-xl"
          whileHover={{ scale: 1.1, rotate: -3 }}
          animate={{ rotate: 2 }}
        >
          <p className="text-primary font-heading font-extrabold text-2xl">2014–2020 🏛️</p>
          <p className="text-primary/70 text-sm font-medium">Adjoint au maire</p>
        </motion.div>
      </motion.div>
      ...
      >
        <motion.div
          className="w-10 h-10 rounded-full bg-campaign-green/20 flex items-center justify-center"
          animate={{ y: [0, 8, 0] }}
          transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
        >
          <ArrowDown className="w-5 h-5 text-campaign-green" />
        </motion.div>
      </motion.div>
    </section>
  );
