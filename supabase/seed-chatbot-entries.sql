...
INSERT INTO chatbot_entries (id, question, answer, category, parent_id, sort_order, is_active) VALUES
...
-- --- Le candidat (enfants) ---
INSERT INTO chatbot_entries (question, answer, category, parent_id, sort_order, is_active) VALUES
('Son parcours',
 ...
 'Candidat', 'c0000000-0000-0000-0000-000000000001', 1, true),
...
('Sa motivation',
 ...
 'Candidat', 'c0000000-0000-0000-0000-000000000001', 2, true);
...
('Écoles, crèches et centre aéré',
 ...
 'Programme', 'c0000000-0000-0000-0000-000000000002', 1, true),
...
('Mixité sociale choisie (BRS)',
 ...
 'Programme', 'c0000000-0000-0000-0000-000000000002', 2, true),
...
('Référendum local',
 ...
 'Programme', 'c0000000-0000-0000-0000-000000000002', 3, true),
...
('Réseau 5G communal et caméras',
 ...
 'Programme', 'c0000000-0000-0000-0000-000000000002', 4, true),
...
('Lutte contre les moustiques',
 ...
 'Programme', 'c0000000-0000-0000-0000-000000000002', 5, true),
...
('Urbanisation maîtrisée',
 ...
 'Programme', 'c0000000-0000-0000-0000-000000000002', 6, true),
...
('6 agents de police supplémentaires',
 ...
 'Programme', 'c0000000-0000-0000-0000-000000000002', 7, true),
...
('Gouvernance métropolitaine',
 ...
 'Programme', 'c0000000-0000-0000-0000-000000000002', 8, true),
...
('Fast lanes boucaines',
 ...
 'Programme', 'c0000000-0000-0000-0000-000000000002', 9, true);
...
('Dates clés',
 ...
 'Élection', 'c0000000-0000-0000-0000-000000000003', 1, true),
...
('Faire une procuration',
 ...
 'Élection', 'c0000000-0000-0000-0000-000000000003', 2, true);
...
('Agir sur le terrain',
 ...
 'Engagement', 'c0000000-0000-0000-0000-000000000004', 1, true),
...
('Réseaux sociaux',
 ...
 'Engagement', 'c0000000-0000-0000-0000-000000000004', 2, true),
...
('Donner votre avis',
 ...
 'Engagement', 'c0000000-0000-0000-0000-000000000004', 3, true);
