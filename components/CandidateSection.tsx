        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl aspect-[4/5] sm:aspect-[3/4]">
                <Image src={candidatImg} alt="Mathieu Morateur, candidat aux municipales 2026 à Bouc-Bel-Air" fill className="object-cover object-[center_20%] sm:object-top" sizes="(max-width: 1024px) 100vw, 50vw" />
