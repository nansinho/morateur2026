              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-4">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-6 min-w-0">
                  <span className="font-accent font-extrabold text-sm sm:text-base tracking-wider uppercase whitespace-nowrap">
                    <span className="text-white">Votez</span>{' '}
                ...
                <div className="flex items-center gap-3 sm:gap-4 shrink-0">
                  {countdown && (
                    <div className="flex items-center gap-1.5 text-xs text-white/90">
                      <span className="text-white/70 font-medium">{targetLabel} :</span>
                  ...
                  <Link
                    href="/programme"
                    className="flex items-center gap-1.5 bg-white/20 hover:bg-white/30 border border-white/30 text-white text-xs font-bold px-3 py-1.5 rounded-lg transition-colors whitespace-nowrap"
                  >
                    Notre programme
                  ...
                  <button
                    ...
                    className="flex items-center justify-center h-6 w-6 rounded text-white/50 hover:text-white hover:bg-white/10 transition-colors"
                  >
